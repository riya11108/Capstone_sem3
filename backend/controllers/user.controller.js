        ...
        if (file) {
            ...
            if (process.env.CLOUD_NAME && process.env.API_KEY && process.env.API_SECRET) {
                try {
                    ...
                    // Proceed without profile photo if upload fails
                }
            } else {
                console.warn("Cloudinary credentials missing. Skipping profile photo upload.");
            }
        }
...
export const updateProfile = async (req, res) => {
    try {
        ...
        if (cloudResponse) {
            // Check if the uploaded file is an image or a PDF/document
